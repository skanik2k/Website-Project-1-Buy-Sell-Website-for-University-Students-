                ...
                <div class="row basic_user_log_area">
                    ...
                    <div class="col-md-7 signup">
                        <form method="POST" action="#" name="signup" id="signup" class="form-group">
                            ...
                            <input type="checkbox" id="agree" value="agreed" name="agree" />I agree to the Terms and Conditions of <a href="index.php">LogeAchi.com</a><br>
...
if (isset($_POST['sub'])) {
    ...
    if (empty($fullname) || empty($username) || empty($useremail) || empty($Upass) || empty($uphone) || empty($Usertype) || empty($useragreement)) {
