...
<body>
 ...
 <header id="header">
        <div class="container">
            <div class="row">
                <div class="col-md-2"><a class="navbar-brand" href="index.php">LogeAchi.com</a></div>
                <div class="col-md-3 pdt"><a href="allads.php"><button class="btn btn-info " type="submit">all ads</button></a></div>
  ...
  <div class="col-md-9">    
    ...
    <form id="adpost" action="#" method="post" enctype="multipart/form-data" class="form-group">
        ...
        <p>
            <label for="">Price (Include TK) :</label>
   ...
   if(isset($_POST['submit'])){
	   ...
	   $insertdata = "INSERT INTO `buynsell`.`product` (`id`, `user_id`, `title`, `description`, `price`, `image`, `areaid`,  `categoryid`,  `adtype`, `condition`, `expiredate`) VALUES ('', '$userid', '$title', ' $description', '$price', '$image', '$areaid', '$categoryid', '$type', '$condition',  '')";
